...
void print_title() {
	...
	cout << "=   ==========    ========          =======      =======     =====    ====     =          =  ==        =" << endl;
	cout << "========================================================================================================" << endl;
	cout << "                        OpenMP - Solution B (OMP-DS) - ILP + Dynamic Scheduling                         " << endl;
	cout << "========================================================================================================" << endl;
	SetColor(7);
}

void l_u_d_dynamic(float** a, float** l, float** u, int size, int chunkSize)
{
	//for each column...
...
int main(int argc, char** argv)
{
	...
	for (int i = 0; i < sizeof(threads) / sizeof(threads[0]); i++) {
		...
		l_u_d_dynamic(a, l, u, size, chunkSize);
